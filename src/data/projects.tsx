...
const projects: Project[] = [
  ...
  // +
  { // 01. SmartGlass project
    id: "smartglass",
    category: "Hardware & Software Integration",
    title: "SmartGlass",
    src: "/assets/projects-screenshots/smartglass/1.png",
    screenshots: ["1.png"],
    live: "https://github.com/Dhanux05/smartglass",
    github:"https://github.com/Dhanux05/smartglass",
    skills: {
      frontend: [
        PROJECT_SKILLS.html,
        PROJECT_SKILLS.css,
      ...
      return (
        <div>
          <TypographyP className="font-mono text-black dark:text-white">
            SmartGlass is an innovative hardware and software integration project that combines 
            smart technology with wearable devices. This project demonstrates advanced IoT concepts 
            and embedded systems programming.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyH3 className="my-4 mt-8 text-black dark:text-white">Features</TypographyH3>
          <p className="font-mono mb-2 text-black dark:text-white">
            SmartGlass integrates hardware components with software solutions to create a seamless 
            user experience. The project showcases skills in embedded systems, IoT development, and 
  ...
  { // 02. AI Voice Bank project
    id: "aivoicebank",
    category: "AI & Voice Technology",
    title: "AI Voice Bank",
    src: "/assets/projects-screenshots/aivoicebank/1.png",
    screenshots: ["1.png"],
    live: "https://github.com/Dhanux05/Ai-Voice-Bank",
    github: "https://github.com/Dhanux05/Ai-Voice-Bank",
    skills: {
      frontend: [
        PROJECT_SKILLS.html,
        PROJECT_SKILLS.css,
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center text-black dark:text-white">
            AI Voice Bank
          </TypographyP>
          <TypographyP className="font-mono text-black dark:text-white">
            AI Voice Bank is an advanced voice technology project that leverages artificial intelligence 
            to process, analyze, and generate voice content. This project showcases integration of AI 
            technologies with voice processing capabilities, demonstrating expertise in modern AI 
            applications and voice recognition systems.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyH3 className="my-4 mt-8 text-black dark:text-white">Technology Stack</TypographyH3>
          <p className="font-mono mb-2 text-black dark:text-white">
            Built using modern web technologies and AI frameworks, AI Voice Bank combines frontend 
            user interfaces with powerful backend AI processing to deliver a comprehensive voice 
            management solution.
          </p>
        </div>
      );
  ...
  { // 03. Real Meta Museum project
    id: "realmetamuseum",
    category: "Metaverse & Virtual Reality",
    title: "Real Meta Museum",
    src: "/assets/projects-screenshots/realmetamuseum/1.png",
    screenshots: ["1.png"],
    live: "https://github.com/Dhanux05/real-meta-museum",
    github:"https://github.com/Dhanux05/real-meta-museum",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
    ...
    get content() {
      return (
        <div>
          ...
          <TypographyP className="font-mono text-black dark:text-white">
            Real Meta Museum is an immersive virtual reality experience that brings museum 
            exhibitions into the metaverse. This innovative project combines cutting-edge 
            web technologies with virtual reality to create an engaging and accessible way 
            to explore art and history. Experience curated collections in a fully interactive 
            3D environment that transcends physical boundaries.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyH3 className="my-4 mt-8 text-black dark:text-white">Features</TypographyH3>
          <p className="font-mono mb-2 text-black dark:text-white">
            Real Meta Museum offers an immersive experience where users can explore virtual 
            exhibitions, interact with artifacts, and learn about history and art in a 
            revolutionary digital space. Built with modern web technologies to deliver 
            smooth performance and engaging interactions.
          </p>
        </div>
      );
    },
  },
  { // 04. Delusion-AI project
    id: "delusionai",
    category: "AI & Machine Learning",
    title: "Delusion AI",
    src: "/assets/projects-screenshots/delusionai/1.png",
    screenshots: ["1.png"],
    live: "https://github.com/Dhanux05/Delusion-AI",
    github:"https://github.com/Dhanux05/Delusion-AI",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
        PROJECT_SKILLS.react,
    ...
    get content() {
      return (
        <div>
          ...
          <TypographyP className="font-mono text-black dark:text-white">
            Delusion AI is an advanced artificial intelligence project built with TypeScript, 
          ...
          <TypographyH3 className="my-4 mt-8 text-black dark:text-white">Features</TypographyH3>
          <p className="font-mono mb-2 text-black dark:text-white">
            Delusion AI leverages advanced AI technologies to deliver intelligent solutions. 
            Built with TypeScript for type safety and modern React for the user interface, 
            this project showcases skills in AI integration, backend development, and creating 
            seamless user experiences with artificial intelligence.
          </p>
        </div>
      );
    },
