            ...
            <>
              <div className="">
                <BlurIn delay={0.7}>
                  <p
                    className={cn(
                      "md:self-start mt-4 font-thin text-sm sm:text-md md:text-lg text-slate-500 dark:text-zinc-400 ml-3",
                ...
                <BlurIn delay={1.2}>
                  <p
                    className={cn(
                      "md:self-start md:mt-4 font-thin text-sm sm:text-md md:text-lg text-slate-500 dark:text-zinc-400 ml-3",
                      "cursor-default font-display whitespace-nowrap bg-clip-text "
                    )}
                  >
                    Web Enthusiast
